                ...
                <div className="flex flex-col mb-6">
                  <div className="flex justify-center gap-4 bg-gray-100 dark:bg-gray-700 rounded-lg p-1 transition-all duration-200">
                    <button
                      ...
                      onClick={() => { setAuthType('email'); setOtpSent(false); setConfirmResult(null); setNameError(''); }}
                    >
                    ...
                    <button
                      ...
                      onClick={() => { setAuthType('phone'); setOtpSent(false); setConfirmResult(null); setNameError(''); }}
                    >
