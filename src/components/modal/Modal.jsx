...
export default function Modal({ name, address, pincode, phoneNumber, setName, setAddress, setPincode, setPhoneNumber, cartItems = [], totalAmount, houseNo, setHouseNo, landmark, setLandmark, blockNo, setBlockNo, userEmail, city, setCity, state, setState }) {
    ...
    const validateFields = () => {
        ...
        else if (!isValidPhone(phoneNumber)) newErrors.phoneNumber = 'Please enter exactly 10 digits starting with 6, 7, 8, or 9. Sequential numbers and repeated digits are not allowed.';
        ...
        if (alternatePhone && !isValidAlternatePhone(alternatePhone)) newErrors.alternatePhone = 'Please enter exactly 10 digits starting with 6, 7, 8, or 9. Sequential numbers and repeated digits are not allowed. Must be different from primary number.';
