...
export default function Navbar() {
  ...
  return (
    <div className={`fixed top-0 left-0 right-0 z-[50] transition-all duration-500 w-full max-w-screen` +
      ...
      {/* Announcement Bar */}
      <div className={`relative overflow-hidden transition-all duration-300 w-full` +
        ...
        <p className="relative w-full text-center font-medium text-white px-2 py-1 sm:py-2 sm:text-base text-sm whitespace-normal break-words overflow-x-auto">
        ...
        <div className="flex h-16 items-center justify-between w-full">
          ...
          >
            ...
            <div className="relative flex items-center justify-center w-6 h-6">
              <MenuIcon className="h-6 w-6 transform transition-transform duration-200 group-hover:scale-110" />
            </div>
          </button>
          ...
          >
            <div className="relative min-w-0 max-w-full truncate">
              ...
              <h1 className={`relative text-2xl font-bold min-w-0 max-w-full truncate`}>
                NaveDhana
              </h1>
            </div>
          </Link>
          ...
          <div className="flex items-center space-x-2 sm:space-x-4 min-w-0 max-w-full">
            ...
            {user ? (
              <Menu as="div" className="relative">
                <Menu.Button className={`relative p-2 rounded-full transition-all duration-200 group`}>
                  <div className="absolute -inset-1 rounded-full bg-gradient-to-r from-green-600 to-green-400 opacity-0 group-hover:opacity-20 transition-opacity duration-200 blur"></div>
                ...
                >
                  <Menu.Items className={`absolute right-0 mt-2 w-48 origin-top-right rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none`}>
                    <div className="py-1">
                      <Menu.Item>
                        {({ active }) => (
                          <Link
              ...
              <button
                ...
                className={`relative inline-flex items-center min-w-0 max-w-full px-3 sm:px-4 py-2 rounded-lg font-medium transition-all duration-200 group overflow-hidden truncate text-ellipsis whitespace-nowrap`}
              >
                <div className="absolute inset-0 bg-white opacity-0 group-hover:opacity-10 transition-opacity duration-200"></div>
                <span className="relative flex items-center min-w-0 max-w-full truncate">
                  <User className="mr-2 h-4 w-4 min-w-0 max-w-full" />
                  Login
                </span>
              </button>
            )}
