...
function UpdateProduct() {
    ...
    useEffect(() => {
        console.log("UpdateProduct useEffect - id:", id, "product length:", product.length);
                    ...
                    <form onSubmit={handleSubmit} className="p-8 space-y-8">
                        ...
                        <div className="flex justify-center gap-4 pt-6">
                            <button 
                                type="button" 
                                onClick={() => navigate('/dashboard')} 
                                className="px-8 py-4 rounded-2xl bg-gray-100 text-gray-700 font-semibold text-lg hover:bg-gray-200 transition-all duration-300 border-2 border-gray-200 hover:border-gray-300"
                            >
                                Cancel
                            </button>
                            <button
