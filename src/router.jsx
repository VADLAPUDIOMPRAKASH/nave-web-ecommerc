...
const orderRoute = createRoute({
  ...
  path: '/order',
  beforeLoad: ({ location }) => {
    console.log('Order route beforeLoad triggered');
    ...
    if (!isAuthenticated) {
      ...
      console.warn('⚠️ User not authenticated but allowing access for debugging');
    ...
    console.log('Proceeding to order page');
  },
  component: Order
});
